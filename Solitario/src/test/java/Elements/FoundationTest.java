...
public class FoundationTest {
    ...
    public void initializeFoundationTest() {
        ...
        Auxiliar.Foundation foundation = new Auxiliar.Foundation(clubs);
    ...
    public void addCorrectCardWhenEmptyTest() {
        Auxiliar.Foundation foundation = new Auxiliar.Foundation(Suit.SPADES);
    ...
    public void cardsCanMoveToEmptyFoundationTest() {
        Auxiliar.Foundation f = new Auxiliar.Foundation(Suit.DIAMOND);
    ...
    public void cardsCantMoveWrongValueTest() {
        Auxiliar.Foundation f = new Auxiliar.Foundation(Suit.HEART);
    ...
    public void removeCardTest(){
        Auxiliar.Foundation f = new Auxiliar.Foundation(Suit.CLUBS);
    ...
    public void notFullFoundationTest(){
        Auxiliar.Foundation f = new Foundation(Suit.DIAMOND);
        for(Value value : Value.values()){
            Card card = new Card(Suit.DIAMOND, value);
            f.addCard(card);
        }
