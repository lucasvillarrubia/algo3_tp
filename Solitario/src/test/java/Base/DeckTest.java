...
public class DeckTest {
        ...
        public void addedCardToDeckTest() {
                ...
                //act
                emptyDeck.addCards(card);
                emptyDeck.addCards(extraCard);
                emptyDeck.addCards(anotherCard);
                emptyDeck.addCards(card);
        ...
        public void removedCardTest() {
                ...
                Deck deck = new Deck();
                deck.addCards(cardPrueba1);
                deck.addCards(cardPrueba2);
                deck.addCards(cardPrueba3);
                deck.addCards(cardPrueba4);
                deck.drawCard();
...
//                shuffledDeck.addCards(cardPrueba3);
//                shuffledDeck.addCards(cardPrueba4);
